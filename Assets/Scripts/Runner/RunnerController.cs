...
public class RunnerController : MonoBehaviour
{
    ...
    public RunnerGameStates currentGameState;
    private RunnerGameStates[] _gameStateSequence;
...
/*    [SerializeField] private GameplayManager _gameplayManager;
    ...
    private void Awake()
    {
        ...
        _gameStateSequence = new RunnerGameStates[4] { RunnerGameStates.StandBy, RunnerGameStates.Countdown, RunnerGameStates.Playing, RunnerGameStates.GameOver };
    ...
    {
        RunnerGameStates currentState = _gameStateSequence[CurrentGameStateIndex];
        switch (currentState)
        {
            case RunnerGameStates.StandBy:
                // Change UI
            ...
            case RunnerGameStates.Countdown:
                // Change UI
            ...
            case RunnerGameStates.GameOver:
                // Bird fly
    ...
    IEnumerator TestingSequence()
    {
        for (int i = 0; i < 5; i++)
        {
            ...
            yield return new WaitForSeconds(5);
            if (_gameStateSequence[CurrentGameStateIndex] == RunnerGameStates.Playing)
            {
                yield return null;
            }
            else
